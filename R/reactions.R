...
github_issue_reactions <- function(repo, id) {
  github_reactions(repo, type = "issue", id = id)
}
...
github_reactions <- function(repo, id,
  headers = c(Accept = "application/vnd.github.squirrel-girl-preview+json"),
  type = c("issue", "comment")) 
{
